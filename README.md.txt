...
* **Resolution:** Images are $96 \times 96$ (resized to $224 \times 224$ for DINOv2 compatibility).

## 💻 How to Run
1. Clone the repo:
   ```bash
   git clone [https://github.com/yourusername/stl10-foundation-vs-cnn.git](https://github.com/yourusername/stl10-foundation-vs-cnn.git)